// src/modules/consulta-proveedor/application/dtos/proveedor-search-request.dto.ts

import { SortCriteriaDto } from './sort-criteria.dto';

/**
 * DTO para recibir solicitudes de búsqueda de proveedores
 */
export class ProveedorSearchRequestDto {
  /**
